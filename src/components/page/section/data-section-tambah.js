...
function DataSectionTambah() {
    ...
    const simpanData = async()=> {
        ...
        const hasil = await postRequest(token, 'soal/section', json);
        ...
        <div className="container-fluid">
          <div className="row">
              <div className="col-sm-12">
                <div className='card'>
                  <div className='card-header'>Tambah Section</div>
                  <div className='card-body'>
                    ...
                    <p>
                        <button
                        className='btn btn-success' onClick={simpanData}><i className='fa fa-save'></i> Simpan</button>&nbsp;
...
export default DataSectionTambah;
